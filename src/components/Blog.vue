            ...
            <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                    <div class="news-item">
                        ...
                        <div class="news-contents mb-4">
                            <span class="post-meta-2">{{ blogItems[0].category }}, 4 min read</span>
                            <h3><a href="#">{{ blogItems[0].title }}</a></h3>
                        </div>
                        <p class="mb-0">
                ...
                <div class="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="news-item">
                        ...
                        <div class="news-contents mb-4">
                            <span class="post-meta-2">{{ blogItems[1].category }}, 4 min read</span>
                            <h3><a href="#">{{ blogItems[1].title }}</a></h3>
                        </div>
                        <p class="mb-0">
                            <a href="#" class="read-more-arrow">
                                <svg class="bi bi-arrow-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-md-12 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="news-item">
                        ...
                        <div class="news-contents mb-4">
                            <span class="post-meta-2">{{ blogItems[2].category }}, 4 min read</span>
                            <h3><a href="#">{{ blogItems[2].title }}</a></h3>
                        </div>
                        <p class="mb-0">
                            <a href="#" class="read-more-arrow">
                                <svg class="bi bi-arrow-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
